...
<template>
    <div class="py-24 container space-y-4">
      <NuxtLink to="/projects" class="inline-flex items-center gap-3 font-geistmono px-4 py-2.5 bg-primary dark:bg-primary_dark border border-secondary dark:border-secondary_dark rounded-xl"><Icon name="lucide:chevron-left" size="24"/>Retour</NuxtLink>
      ...
      <div><Icon v-for="tool in data?.tools" :key="tool" :name="`simple-icons:${tool}`" size="24"/></div>
    </div>
</template>